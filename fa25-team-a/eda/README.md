...
* Pipeline:
   ...
   3. Parsed and concatenated address fields into structured columns (Town, Development, Address, Unit Number) for **Resale Transaction Info updated Sept 2025**. *Ref: ParseResaleData.ipynb.* 
