...
def normalize_race(df: pd.DataFrame, col: str = "Race/Ethnicity") -> pd.DataFrame:
    out = df.copy()
    ...
    original_race_counts = out['Race/Ethnicity'].value_counts() # starts with 99 unique race entries
    ...
    out['race_norm_v1']  = (
        out['race_norm_v1'].mask
        (out['race_norm_v1'].isin(['nan','NaN', 'none', 'null', ''])
        ))
    ...
    unique_race_counts_v1 = out['race_norm_v1'].value_counts() # 99 to 83 different race entries
    unique_race = out['race_norm_v1'].unique()
    # print(unique_race)
    ...
    # down to 80 races
    unique_race_v2 = out['race_norm_v2'].unique()
    #%% Unknowns Cleaning
    ...
    unique_race_v2 = out['race_norm_v2'].unique() # down to 69 races after black/african american normalization
    ...
    unique_race_v3 = out['race_norm_v3'].unique() # down to 57 race options
    ...
    unique_race_v4 = out['race_norm_v4'].unique() # down to 55 race selections 
    ...
    unique_race_v5 = out['race_norm_v5'].unique() # 46 races
    ...
    unique_race_v5 = out['race_norm_v5'].unique() # 36 race options
    ...
    unique_race_v6 = out['race_norm_v6'].unique() # 27 combos
    ...
    unique_race_v6 = out['race_norm_v6'].unique() # 25 combos
    ...
    unique_race_final = out['race_norm_final'].unique() # 22 combos
    ...
    out['is_mixed_race'] = out[[f'dummy_{race}' for race in race_name_map]].sum(axis=1).gt(1).astype(int)

    race_cleaning_process_out = out[
    ...
    # race_cleaning_process_out.to_csv('race_normalization_iterations.csv')
